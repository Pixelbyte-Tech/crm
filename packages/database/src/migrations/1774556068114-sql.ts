...
export class Sql1774556068114 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "trading_account_schema_leverage" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "leverages" integer array NOT NULL, "allowedCountries" character varying(3) array, "excludedCountries" character varying(3) array, "tradingAccountSchemaId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_51d76dba6a34c18135f3f0cfcfd" UNIQUE ("tradingAccountSchemaId", "leverages", "allowedCountries", "excludedCountries"), CONSTRAINT "PK_981443941574235edf2b8ed16f5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_39a674b170f7134695fbcf02bd" ON "trading_account_schema_leverage" ("tradingAccountSchemaId") `,
    );
    await queryRunner.query(
      `CREATE TABLE "trading_account_schema" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "description" text, "isEnabled" boolean NOT NULL DEFAULT false, "isKycRequired" boolean NOT NULL DEFAULT false, "allowedLeverages" integer array, "allowedCurrencies" character varying(3) array, "allowedCountries" character varying(3) array, "excludedCountries" character varying(3) array, "minDepositAmountUsd" numeric, "maxDepositAmountUsd" numeric, "maxAccountsPerUser" smallint, "platformUserGroupId" text NOT NULL, "serverId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_e087998fb7e7a738f97f9af53ca" UNIQUE ("serverId", "platformUserGroupId"), CONSTRAINT "UQ_0c0251f92be9c0f259c0020407d" UNIQUE ("name"), CONSTRAINT "PK_f1086de302be3bed28455e32f8f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`CREATE INDEX "IDX_f0ca9cd19629f28e9388e09c43" ON "trading_account_schema" ("serverId") `);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."audit_log_targettype_enum" AS ENUM('user', 'document', 'note', 'wallet', 'trading_account', 'session', 'setting', 'integration', 'server', 'platform_client', 'tag', 'other')`,
    );
    await queryRunner.query(`CREATE TYPE "public"."audit_log_result_enum" AS ENUM('success', 'failure')`);
    await queryRunner.query(
      `CREATE TABLE "audit_log" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "actor" "public"."audit_log_actor_enum" NOT NULL, "targetAction" "public"."audit_log_targetaction_enum" NOT NULL, "targetType" "public"."audit_log_targettype_enum" NOT NULL DEFAULT 'other', "targetId" uuid NOT NULL, "result" "public"."audit_log_result_enum" NOT NULL DEFAULT 'success', "failureReason" text, "ipAddress" inet, "userAgent" text, "requestId" text, "metadata" jsonb, "occurredAt" TIMESTAMP NOT NULL, "eventId" text NOT NULL, "userId" uuid, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0a5cdb588008e852bb876b8810c" PRIMARY KEY ("id", "createdAt")) PARTITION BY RANGE ("createdAt")`,
    );
    ...
    await queryRunner.query(`CREATE INDEX "IDX_2a311d5dab3e802e7d50512fb0" ON "audit_log" ("occurredAt") `);
    ...
    await queryRunner.query(
      `CREATE TABLE "mystery_box" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" text NOT NULL, "pointsCost" smallint NOT NULL, "isEnabled" boolean NOT NULL DEFAULT false, "rewards" jsonb NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1c40b115f6e687bbd6289af53db" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "user_mystery_box" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "pointsPaid" smallint NOT NULL, "awardedAt" TIMESTAMP NOT NULL DEFAULT now(), "openedAt" TIMESTAMP, "rewardId" uuid NOT NULL, "mysteryBoxId" uuid NOT NULL, "userId" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_69e98bb23a960b72c34c5037549" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`CREATE INDEX "IDX_9cd9b2e7287d2570bee0b55284" ON "user_mystery_box" ("rewardId") `);
    await queryRunner.query(`CREATE INDEX "IDX_ecc644f455969eefa511a9efb9" ON "user_mystery_box" ("mysteryBoxId") `);
    await queryRunner.query(`CREATE INDEX "IDX_765d9d40e0286f95efdf149bc1" ON "user_mystery_box" ("userId") `);
    await queryRunner.query(
      `CREATE TYPE "public"."reward_type_enum" AS ENUM('discount', 'credit', 'cashback', 'physical', 'other')`,
    );
    await queryRunner.query(
      `CREATE TABLE "reward" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" "public"."reward_type_enum" NOT NULL, "name" character varying NOT NULL, "description" text NOT NULL, "isEnabled" boolean NOT NULL DEFAULT false, "settings" jsonb NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a90ea606c229e380fb341838036" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."user_reward_source_enum" AS ENUM('login', 'mystery_box', 'spin_and_win', 'manual', 'system')`,
    );
    await queryRunner.query(
      `CREATE TABLE "user_reward" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "pointsPaid" smallint, "source" "public"."user_reward_source_enum" NOT NULL, "awardedAt" TIMESTAMP NOT NULL DEFAULT now(), "rewardId" uuid NOT NULL, "userId" uuid NOT NULL, "awardedByUserId" uuid, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_870b280d018d4f7520abec33561" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`CREATE INDEX "IDX_ba319255c60a14b32e078b7350" ON "user_reward" ("rewardId") `);
    await queryRunner.query(`CREATE INDEX "IDX_ef8e443d9a7cd2881b2e75ae35" ON "user_reward" ("userId") `);
    await queryRunner.query(`CREATE INDEX "IDX_7e500605e47e9257c25e7ec87a" ON "user_reward" ("awardedByUserId") `);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."platform_client_platform_enum" AS ENUM('mt5', 'ctrader', 'tradelocker', 'dxtrade', 'yourbourse')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."platform_client_type_enum" AS ENUM('windows', 'mac', 'linux', 'osx', 'android', 'web')`,
    );
    await queryRunner.query(
      `CREATE TABLE "platform_client" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "platform" "public"."platform_client_platform_enum" NOT NULL, "type" "public"."platform_client_type_enum" NOT NULL, "link" text NOT NULL, "settings" jsonb, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_4855805bfc5a9e538b410c4c5d9" UNIQUE ("platform", "type"), CONSTRAINT "PK_1b1eacd5b73803aef3bec878b8e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "payment_promo_code" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "code" character varying NOT NULL, "amount" smallint NOT NULL, "isPercentage" boolean NOT NULL DEFAULT true, "isEnabled" boolean NOT NULL DEFAULT false, "validFrom" TIMESTAMP, "validTo" TIMESTAMP, "maxUsesTotal" smallint, "maxUsesPerUser" smallint DEFAULT '1', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f61304f6e7347a9380bc0a6f8e3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."global_setting_key_enum" AS ENUM('company_name', 'user_can_deposit', 'user_can_withdraw', 'user_can_auto_withdraw', 'user_max_auto_withdraw_amt', 'user_invitation_expire_days')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "trading_account_schema_leverage" ADD CONSTRAINT "FK_39a674b170f7134695fbcf02bdd" FOREIGN KEY ("tradingAccountSchemaId") REFERENCES "trading_account_schema"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "trading_account_schema" ADD CONSTRAINT "FK_f0ca9cd19629f28e9388e09c432" FOREIGN KEY ("serverId") REFERENCES "server"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_mystery_box" ADD CONSTRAINT "FK_9cd9b2e7287d2570bee0b552843" FOREIGN KEY ("rewardId") REFERENCES "reward"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_mystery_box" ADD CONSTRAINT "FK_ecc644f455969eefa511a9efb9e" FOREIGN KEY ("mysteryBoxId") REFERENCES "mystery_box"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_mystery_box" ADD CONSTRAINT "FK_765d9d40e0286f95efdf149bc1b" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_reward" ADD CONSTRAINT "FK_ba319255c60a14b32e078b7350a" FOREIGN KEY ("rewardId") REFERENCES "reward"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_reward" ADD CONSTRAINT "FK_ef8e443d9a7cd2881b2e75ae35d" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_reward" ADD CONSTRAINT "FK_7e500605e47e9257c25e7ec87ae" FOREIGN KEY ("awardedByUserId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE CASCADE`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "user_mystery_box" DROP CONSTRAINT "FK_765d9d40e0286f95efdf149bc1b"`);
    await queryRunner.query(`ALTER TABLE "user_mystery_box" DROP CONSTRAINT "FK_ecc644f455969eefa511a9efb9e"`);
    await queryRunner.query(`ALTER TABLE "user_mystery_box" DROP CONSTRAINT "FK_9cd9b2e7287d2570bee0b552843"`);
    ...
    await queryRunner.query(`ALTER TABLE "trading_account_schema" DROP CONSTRAINT "FK_f0ca9cd19629f28e9388e09c432"`);
    await queryRunner.query(
      `ALTER TABLE "trading_account_schema_leverage" DROP CONSTRAINT "FK_39a674b170f7134695fbcf02bdd"`,
    );
    ...
    await queryRunner.query(`DROP TABLE "payment_promo_code"`);
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_7e500605e47e9257c25e7ec87a"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_ef8e443d9a7cd2881b2e75ae35"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_ba319255c60a14b32e078b7350"`);
    await queryRunner.query(`DROP TABLE "user_reward"`);
    await queryRunner.query(`DROP TYPE "public"."user_reward_source_enum"`);
    await queryRunner.query(`DROP TABLE "reward"`);
    await queryRunner.query(`DROP TYPE "public"."reward_type_enum"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_765d9d40e0286f95efdf149bc1"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_ecc644f455969eefa511a9efb9"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_9cd9b2e7287d2570bee0b55284"`);
    await queryRunner.query(`DROP TABLE "user_mystery_box"`);
    await queryRunner.query(`DROP TABLE "mystery_box"`);
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_936a31c3fca31a0b332f924a3a"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_2621409ebc295c5da7ff3e4139"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_2a311d5dab3e802e7d50512fb0"`);
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_f0ca9cd19629f28e9388e09c43"`);
    await queryRunner.query(`DROP TABLE "trading_account_schema"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_39a674b170f7134695fbcf02bd"`);
    await queryRunner.query(`DROP TABLE "trading_account_schema_leverage"`);
